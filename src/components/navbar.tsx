                        ...
                        {(pathname.startsWith('/shop') || pathname.startsWith('/profile') || pathname === '/cart' || pathname === '/checkout' || pathname === '/orders' || pathname === '/login') && (
                                <>
                                    <div className="relative" ref={profileMenuRef}>
                                        ...
                                        {profileMenuOpen && (
                                            <div style={{ position: "absolute", right: "-20px", top: "48px", width: "180px", backgroundColor: "white", boxShadow: "0 4px 24px rgba(0,0,0,0.12)", borderRadius: "6px", overflow: "hidden", display: "flex", flexDirection: "column", zIndex: 50, border: "1px solid #e5e7eb", fontFamily: "var(--font-body)" }}>
                                    ...
                                    <div className="relative" ref={helpMenuRef}>
                                        <button
                                            ...
                                            className="hover:text-blue-600 transition-colors"
                                        >
                                            <span style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--font-body)", letterSpacing: "0.08em" }}>Help</span>
                                    ...
                                    {searchResults.map(product => (
                                        ...
                                        >
                                            ...
                                            <div style={{ flex: 1 }}>
                                                ...
                                                <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "14px", fontFamily: "var(--font-body)" }}>{product.category} • NGN {product.price.toLocaleString()}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
