...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleShare = (platform: string) => {
        ...
        const text = `Check out ${product.name} on Stanch Tech!`;
                            ...
                            <div className="flex items-center justify-between py-6" style={{ marginTop: "32px" }}>
                                ...
                                <div className="flex gap-4 items-center">
                                    ...
                                    <div className="flex gap-5 items-center">
                                        <Facebook onClick={() => handleShare('facebook')} size={18} color="#1877F2" strokeWidth={2} className="cursor-pointer hover:scale-110 transition-transform" />
                                        <Instagram onClick={() => handleShare('instagram')} size={18} color="#E4405F" strokeWidth={2} className="cursor-pointer hover:scale-110 transition-transform" />
                                        <svg onClick={() => handleShare('whatsapp')} width="18" height="18" viewBox="0 0 24 24" fill="#25D366" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer hover:scale-110 transition-transform">
