            ...
            <div style={{ paddingLeft: "109.27px", paddingRight: "109.27px" }}>
                ...
                <section className="w-full flex flex-col lg:flex-row gap-20 items-start">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-6" style={{ marginBottom: "0px" }}>
                            <div className="flex gap-1.5" style={{ color: "#FFDA5B" }}>
                                {[...Array(5)].map((_, i) => <Star key={i} size={16} fill="currentColor" strokeWidth={0} />)}
                            </div>
                            <div className="h-4 border-l-2 border-gray-300" style={{ marginLeft: "2px", marginRight: "8px" }} />
                            <span className="text-sm font-bold text-gray-400 uppercase tracking-[0.2em] leading-none" style={{ fontFamily: "'Darker Grotesque', sans-serif" }}>
                                Customer Review
                            </span>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-8" style={{ marginTop: "96px", marginBottom: "80px" }}>
                            {/* QUANTITY BOX */}
                            <div className="flex items-center border-2 border-gray-200 rounded-xl px-4 py-2 justify-center gap-10 bg-white shrink-0" style={{ width: "160px", height: "64px" }}>
                        ...
                        <div className="w-full border-t border-gray-200" style={{ marginTop: "8px", marginBottom: "12px" }} />
                        <div className="flex flex-col gap-3 text-[16px] text-[#9F9F9F]" style={{ fontFamily: "'Darker Grotesque', sans-serif" }}>
                            <div className="flex items-center">
                                <span style={{ width: "95px" }}>Part Code</span>
                                <span className="mr-3">:</span>
                                <span>SS001</span>
                            </div>
                            <div className="flex items-center">
                                <span style={{ width: "95px" }}>Category</span>
                                <span className="mr-3">:</span>
                                <span>Industrial Parts</span>
                            </div>
                            <div className="flex items-center">
                                <span style={{ width: "95px" }}>Tags</span>
                                <span className="mr-3">:</span>
                                <span>Marine, Parts, Industrial, Shop</span>
                            </div>
                            <div className="flex items-center">
                                <div className="flex items-center">
                                    <span style={{ width: "95px" }}>Share</span>
                                    <span className="mr-3">:</span>
                                    <div className="flex items-center gap-4 text-black">
                                        <Facebook size={20} fill="black" strokeWidth={0} className="cursor-pointer hover:text-blue-600 transition-colors" />
                                        <Instagram size={20} className="cursor-pointer hover:text-pink-600 transition-colors" />
                                        <svg className="cursor-pointer hover:text-green-500 transition-colors" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
