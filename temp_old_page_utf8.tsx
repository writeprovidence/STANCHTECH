  ...
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      <section style={{
        ...
        <div className="hero-content-wrapper" style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 24px", maxWidth: 900, width: "100%" }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/shop" target="_blank" className="hero-btn-secondary" style={{ border: "2.5px solid #ffffff !important", borderColor: "#ffffff !important" }}>
      ...
      <section style={{ 
        ...
        {/* ΓöÇΓöÇΓöÇ CORE BUSINESS AREAS ΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇΓöÇ CUMMINS ENGINES ΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇ MARINE VESSEL INSPECTION ΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇ SPARES & SUPPORT ΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇ FEATURED PRODUCTS ΓöÇΓöÇΓöÇ */}
        ...
        <div className="products-grid" style={{ maxWidth: 1400, margin: "0 auto", gap: 32, position: "relative" }}>
          ...
          <div className="product-item-card" style={{ 
            ...
            <div style={{ flex: 1, background: "#0b1a2e", padding: "25px 44px 55px 44px", color: "#fff", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", textAlign: "left" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 32px", display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start" }}>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó High-Pressure Performance</li>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó Saltwater Corrosion Resistant</li>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó 24-Month Active Warranty</li>
              </ul>
          ...
          <div className="product-item-card" style={{ 
            ...
            <div style={{ flex: 1, background: "#105C7A", padding: "25px 44px 55px 44px", color: "#fff", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", textAlign: "left" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 32px", display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start" }}>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó Ultra-Fine Fuel Atomization</li>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó OEM Grade Compatibility</li>
                <li style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.72)", textAlign: "left", whiteSpace: "nowrap", fontFamily: "'Darker Grotesque', sans-serif" }}>ΓÇó Optimized Fuel Efficiency</li>
              </ul>
